...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  HAL_PCDEx_PMAConfig((PCD_HandleTypeDef*)pdev->pData , PCAN_USB_EP_CMDOUT , PCD_SNG_BUF, 0x100);
  HAL_PCDEx_PMAConfig((PCD_HandleTypeDef*)pdev->pData , PCAN_USB_EP_CMDIN , PCD_SNG_BUF, 0x140);
  HAL_PCDEx_PMAConfig((PCD_HandleTypeDef*)pdev->pData , PCAN_USB_EP_MSGOUT_CH1 , PCD_SNG_BUF, 0x180);
  HAL_PCDEx_PMAConfig((PCD_HandleTypeDef*)pdev->pData , PCAN_USB_EP_MSGIN_CH1 , PCD_SNG_BUF, 0x1C0);
  HAL_PCDEx_PMAConfig((PCD_HandleTypeDef*)pdev->pData , PCAN_USB_EP_MSGOUT_CH2 , PCD_SNG_BUF, 0x200);
  HAL_PCDEx_PMAConfig((PCD_HandleTypeDef*)pdev->pData , PCAN_USB_EP_MSGIN_CH2 , PCD_SNG_BUF, 0x240);
